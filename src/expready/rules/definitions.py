...
RULES: dict[str, RuleDefinition] = {
    ...
    "CROSS_PATH_001": RuleDefinition(
        rule_id="CROSS_PATH_001",
        severity=Severity.ERROR,
        title="Manifest path column was not found",
        description="The manifest does not contain the path column requested for file-location checks.",
        rationale="Path-level validation cannot run without a valid path column.",
        suggested_fix="Provide the correct manifest path column with --manifest-path.",
        section="cross_file",
    ),
    "CROSS_PATH_002": RuleDefinition(
        rule_id="CROSS_PATH_002",
        severity=Severity.WARNING,
        title="Manifest has duplicate file paths",
        description="At least one file path appears in more than one manifest row.",
        rationale="Duplicate paths can indicate accidental duplicate sample mapping.",
        suggested_fix="Ensure each sample points to the intended unique file path.",
        section="cross_file",
    ),
    "CROSS_PATH_003": RuleDefinition(
        rule_id="CROSS_PATH_003",
        severity=Severity.WARNING,
        title="Manifest has missing file paths",
        description="One or more rows in the manifest path column are empty.",
        rationale="Empty file paths prevent downstream tools from finding input files.",
        suggested_fix="Fill missing file path values or remove incomplete manifest rows.",
        section="cross_file",
    ),
    "CROSS_PATH_004": RuleDefinition(
        rule_id="CROSS_PATH_004",
        severity=Severity.ERROR,
        title="Some manifest file paths do not exist",
        description="One or more manifest file paths could not be found on disk.",
        rationale="Missing input files will break downstream processing.",
        suggested_fix="Fix incorrect paths or restore missing files before running downstream workflows.",
        section="cross_file",
    ),
